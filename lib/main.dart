...
class _BodyDiagramScreenState extends State<BodyDiagramScreen> {
  ...
  'chest': [
    Exercise('Bench Press', 'assets/images/chest/Bench Press.jpg', 'https://www.youtube.com/watch?hWbUlkb5Ms4'),
    Exercise('Close-Grip Bench Press', 'assets/images/chest/Close-Grip Bench Press.jpg', 'https://www.youtube.com/watch?4yKLxOsrGfg'),
    Exercise('Wide-Grip Bench Press', 'assets/images/chest/Wide-Grip Bench Press.jpg', 'https://www.youtube.com/watch?NQNWLYJTtHA'),
    Exercise('Incline Bench Press', 'assets/images/chest/Incline Bench Press.jpg', 'https://www.youtube.com/watch?8fXfwG4ftaQ'),
    Exercise('Decline Barbell Press', 'assets/images/chest/Decline Barbell Press.jpg', 'https://www.youtube.com/watch?a-UFQE4oxWY'),
    Exercise('Incline Dumbbell Bench Press', 'assets/images/chest/Incline Dumbbell Bench Press.jpg', 'https://www.youtube.com/watch?Gruq177Psnk'),
    Exercise('Decline Dumbbell Bench Press', 'assets/images/chest/Decline Dumbbell Bench Press.jpg', 'https://www.youtube.com/watch?5JiZFjxyoJQ'),
    Exercise('Dumbbell Chest Press', 'assets/images/chest/Dumbbell Chest Press.jpg', 'https://www.youtube.com/watch?WbCEvFA0NJs'),
    Exercise('Dumbbell Chest Flyes', 'assets/images/chest/Dumbbell Chest Flyes.jpg', 'https://www.youtube.com/watch?rk8YayRoTRQ'),
    Exercise('Machine Fly', 'assets/images/chest/Machine Fly.jpg', 'https://www.youtube.com/watch?xYExAgLt_4I'),
    Exercise('Machine Chest Press', 'assets/images/chest/Machine Chest Press.jpg', 'https://www.youtube.com/watch?Qu7-ceCvq7w'),
    Exercise('Dumbbell Pullover', 'assets/images/chest/Dumbbell Pullover.jpg', 'https://www.youtube.com/watch?Datv2L6t3-4'),
    Exercise('Cable Flyes', 'assets/images/chest/Cable Flyes.jpg', 'https://www.youtube.com/watch?y4RJDSOBEl8'),
    Exercise('Incline Cable Flyes', 'assets/images/chest/Incline Cable Flyes.jpg', 'https://www.youtube.com/watch?-Eq_GScOGOE'),
    Exercise('Cable Crossover', 'assets/images/chest/Cable Crossover.jpg', 'https://www.youtube.com/watch?WIErn7-YvYQ'),
  ],
  ...
  'hams': [
    Exercise('Romanian Deadlift', 'images/hams/Romanian Deadlift.jpg', 'https://www.youtube.com/embed/Wou9zVQrAfs'),
    Exercise('Lying Leg Curl', 'images/hams/Lying Leg Curl.jpg', 'https://www.youtube.com/embed/y7SKfM6Hmiw'),
    Exercise('Seated Leg Curl', 'images/hams/Seated Leg Curl.jpg', 'https://www.youtube.com/embed/_lgE0gPvbik'),
    Exercise('Good Mornings', 'images/hams/Good Mornings.jpg', 'https://www.youtube.com/embed/vBf70Aq2i7I'),
    Exercise('Deadlift', 'images/hams/Deadlift.jpg', 'https://www.youtube.com/embed/xNwpvDuZJ3k'),
    Exercise('Single-Leg Romanian Deadlift', 'images/hams/Single-Leg Romanian Deadlift.jpg', 'https://www.youtube.com/embed/s32cCgmRV3I'),
    Exercise('Nordic Hamstring Curl', 'images/hams/Nordic Hamstring Curl.jpg', 'https://www.youtube.com/embed/hcwtmVuLCV4'),
    Exercise('Glute-Ham Raise', 'images/hams/Glute-Ham Raise.jpg', 'https://www.youtube.com/embed/blX1If7ScxY'),
    Exercise('Cable Pull-Through', 'images/hams/Cable Pull-Through.jpg', 'https://www.youtube.com/embed/C_8Dfrq93II'),
    Exercise('Kettlebell Swing', 'images/hams/Kettlebell Swing.jpg', 'https://www.youtube.com/embed/n1df4ASFeZU'),
    Exercise('Reverse Hyperextension', 'images/hams/Reverse Hyperextension.jpg', 'https://www.youtube.com/embed/MaQmKCpxAjk'),
    Exercise('Swiss Ball Leg Curl', 'images/hams/Swiss Ball Leg Curl.jpg', 'https://www.youtube.com/embed/-53wPef9rWI'),
    Exercise('Standing Leg Curl Machine', 'images/hams/Standing Leg Curl.jpg', 'https://www.youtube.com/embed/I9hgElVIzfg'),
    Exercise('Banded Hamstring Curl', 'images/hams/Banded Hamstring Curl.jpg', 'https://www.youtube.com/embed/89o2fRj5G80'),
    Exercise('Stiff-Leg Deadlift', 'images/hams/Stiff-Leg Deadlift.jpg', 'https://www.youtube.com/embed/BM4Q5Potr5A'),
    ],
};
